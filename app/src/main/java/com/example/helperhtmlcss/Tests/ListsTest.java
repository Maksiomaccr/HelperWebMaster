...
public class ListsTest extends AppCompatActivity implements View.OnClickListener {
    ...
    int totalQuestion = QuestionsAnswers3.question.length;
    String selectedAnswer = "";
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lists_test);
    ...
    public void onClick(View v) {
        ...
        if (clickedButton.getId() == R.id.submit3) {
            total++;
            if (selectedAnswer.equals(QuestionsAnswers3.correctAnswers[currentQuestionIndex])) {
                score++;
            }
    ...
    void loadNewQuestion() {
        ...
        question.setText(QuestionsAnswers3.question[currentQuestionIndex]);
        ansA.setText(QuestionsAnswers3.choices[currentQuestionIndex][0]);
        ansB.setText(QuestionsAnswers3.choices[currentQuestionIndex][1]);
        ansC.setText(QuestionsAnswers3.choices[currentQuestionIndex][2]);
        ansD.setText(QuestionsAnswers3.choices[currentQuestionIndex][3]);
    }

    private void finishTest3() {
        String passStatus = "";
        if (score >= totalQuestion) {
            ...
            editor.putInt("newProgress3", prog);
            editor.apply();
