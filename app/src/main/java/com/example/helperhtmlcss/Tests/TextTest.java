...
public class TextTest extends AppCompatActivity implements View.OnClickListener {
    ...
    int totalQuestion = QuestionsAnswers2.question.length;
    ...
    public void onClick(View v) {
        ...
        if (clickedButton.getId() == R.id.submit2) {
            total++;
            if (selectedAnswer.equals(QuestionsAnswers2.correctAnswers[currentQuestionIndex])) {
                score++;
            }
    ...
    void loadNewQuestion() {
        ...
        question.setText(QuestionsAnswers2.question[currentQuestionIndex]);
        ansA.setText(QuestionsAnswers2.choices[currentQuestionIndex][0]);
        ansB.setText(QuestionsAnswers2.choices[currentQuestionIndex][1]);
        ansC.setText(QuestionsAnswers2.choices[currentQuestionIndex][2]);
        ansD.setText(QuestionsAnswers2.choices[currentQuestionIndex][3]);
    }
