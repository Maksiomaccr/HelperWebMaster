...
public class LinksTest extends AppCompatActivity implements View.OnClickListener {
    ...
    int totalQuestion = QuestionsAnswers4.question.length;
    String selectedAnswer = "";
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_links_test);
        ...
        totalQuestionText = findViewById(R.id.totalQuestionText4);
    ...
    public void onClick(View v) {
        ...
        if (clickedButton.getId() == R.id.submit4) {
            total++;
            if (selectedAnswer.equals(QuestionsAnswers4.correctAnswers[currentQuestionIndex])) {
                score++;
            }
    ...
    void loadNewQuestion() {
        ...
        question.setText(QuestionsAnswers4.question[currentQuestionIndex]);
        ansA.setText(QuestionsAnswers4.choices[currentQuestionIndex][0]);
        ansB.setText(QuestionsAnswers4.choices[currentQuestionIndex][1]);
        ansC.setText(QuestionsAnswers4.choices[currentQuestionIndex][2]);
        ansD.setText(QuestionsAnswers4.choices[currentQuestionIndex][3]);
    }

    private void finishTest4() {
        String passStatus = "";
