...
public class Selectors extends AppCompatActivity implements CSS2 {
    TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment = new CSSSelectorsType();
        ...
        button_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Selectors.this, CSSCource.class);
